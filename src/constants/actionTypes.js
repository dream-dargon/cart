...
export const GET_HOME_RECOMMEND = 'GET_HOME_RECOMMEND' //首页部分导航商品
export const GET_DETAILS_ONE = 'GET_DETAILS_ONE' //详情的商品
export const GET_DETAILS_THR_ONEPAGE = 'GET_DETAILS_THR_ONEPAGE' //详情的一页评价
export const GET_DETAILS_THR_PAGES = 'GET_DETAILS_THR_PAGES' //详情的所有评价
>>>>>>> origin/fff
